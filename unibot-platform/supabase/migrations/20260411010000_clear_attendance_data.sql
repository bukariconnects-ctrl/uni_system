-- Fix the trigger to use is_open instead of status, then clear attendance data
...
-- Now clear all attendance data
DELETE FROM attendance_records;
DELETE FROM attendance_summaries;
DELETE FROM attendance_sessions;

-- Restore any enrollments that were dismissed due to attendance
UPDATE enrollments SET status = 'enrolled' WHERE status = 'dismissed';
